...
public class WordServiceImpl implements WordService {
    ...
    @Override
    public List<Table> tableList(String swaggerDocUrl) {
        if(!StringUtils.isBlank(swaggerDocUrl)){
            swaggerUrl = swaggerDocUrl;
        }
        ...
        if (paths != null) {
            ...
            while (it.hasNext()) {
                ...
                title = (String) ((List) content.get("tags")).get(0);
                ...
                preTitle = (String) ((List) content.get("tags")).get(0);
                ...
                tag = (String) content.get("summary");
                //请求体
                ...
                //封装Table
                if (titleSeqIncr) {
                    table.setTitle(titleSeq + " " + title);
                    table.setTag(titleSeq + "." + tagSeq + " " + tag);
                } else {
                    if (titleSeq - 1 == 0) {
                        table.setTag(titleSeq + "." + tagSeq + " " + tag);
                    } else {
                        table.setTag((titleSeq - 1) + "." + tagSeq + " " + tag);
                    }
                }
                table.setUrl(url);
